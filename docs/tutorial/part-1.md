...
::: tip
This part is complete. See the full walkthrough in [`DIY_PROTOAGENT_TUTORIAL/PART_1.md`](https://github.com/user/protoagent/blob/main/DIY_PROTOAGENT_TUTORIAL/PART_1.md).
:::

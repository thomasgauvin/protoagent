...
export const InitComponent = () => {
  ...
  // Step 1: Target selection - let user choose project vs user config
  ...
  // Step 2: Overwrite confirmation - ask before overwriting existing config
  if (selectedTarget && !result) {
  ...
  // Step 3: Result display - show the outcome of the init operation
  if (result) {
